...
// Uses 4 temporaries: v26,v27,v28,v29
...
// Uses 2 temporaries: v14, v15
#define LCE_BMLA2(Vd, Vr, Vl1, Vl2, Vl3, Vl4) \
  "eor v14.16b, " #Vr".16b, "#Vl1".16b\n" \
  "cnt v14.16b, v14.16b\n"            \
  "addv b14, v14.16b\n"               \
  "eor v15.16b, " #Vr".16b, "#Vl2".16b\n" \
  "cnt v15.16b, v15.16b\n"            \
  "addv b15, v15.16b\n"               \
  "ins v14.s[1], v15.s[0]\n"          \
  "eor v15.16b, " #Vr".16b, "#Vl3".16b\n" \
  "cnt v15.16b, v15.16b\n"            \
  "addv b15, v15.16b\n"               \
  "ins v14.s[2], v15.s[0]\n"          \
...
// - 8x8 destination matrices This is done in
// `BinaryKernelNeonOutOfOrder32BP8x8`
...
// During accumulation, v0 -- v13 are used to load data from LHS and RHS.
// Registers v14,v15 are used as temporaries for computation.
// This kernel uses all available registers, so it is imposibble to further
// unroll the depth-loop.
//
//                                          RHS 4x8 block
//                           /---------------------------------------\
//                           |v8  |  v9|v8  |  v9|v8  |  v9|v8  |  v9|
//                           | R1 | R2 | R3 | R4 | R5 | R6 | R7 | R8 |
//                           |v8  |  v9|v8  |  v9|v8  |  v9|v8  |  v9|
//                           \---------------------------------------/
//        LHS 8x4 block
//  /---------------------\  /---------------------------------------\
//  | v0.s[0]     v0.s[3] |  |v16 | v18|v20 | v22|v24 | v26|v28 | v30|
//  | v1.s[0] L1  v1.s[3] |  |    |    |    |    |    |    |    |    |
//  | v2.s[0]     v2.s[3] |  |    |    |    |    |    |    |    |    |
//  | v3.s[0]     v3.s[3] |  |v16 | v18|v20 | v22|v24 | v26|v28 | v30|
//  |                     |  | D1 | D2 | D3 | D4 | D5 | D6 | D7 | D8 |
//  | v4.s[0]     v4.s[3] |  |v17 | v19|v21 | v23|v25 | v27|v29 | v31|
//  | v5.s[0] L2  v5.s[3] |  |    |    |    |    |    |    |    |    |
//  | v6.s[0]     v6.s[3] |  |    |    |    |    |    |    |    |    |
//  | v7.s[0]     v7.s[3] |  |v17 | v19|v21 | v23|v25 | v27|v29 | v31|
//  \---------------------/  \---------------------------------------/
//                                    accumulators 8x8 block

// clang-format on

void BinaryKernelNeonOutOfOrder32BP8x8(
    const BinaryKernelParams<8, 8, std::uint32_t>& params) {
  CheckOffsetsInKernelParams32BP(params);
  gemmlowp::ScopedProfilingLabel label(
      "Binary Kernel (8x8) 32BP (kNeon, optimized for out-of-order cores)");
...
#define RUY_MAKE_ZERO(reg) "dup " #reg ".4s, wzr\n"
      ...
      // LHS, RHS, DST stride are number of *bytes* of a column
      // Depth is number of *elements* (int32) in the depth dimension
      "ldr x5, [%[params], #" RUY_STR(RUY_OFFSET_LHS_BASE_PTR) "]\n"
      "ldr w6, [%[params], #" RUY_STR(RUY_OFFSET_START_ROW) "]\n"
      "ldr w7, [%[params], #" RUY_STR(RUY_OFFSET_LAST_ROW) "]\n"
      "ldr w8, [%[params], #" RUY_STR(RUY_OFFSET_LAST_COL) "]\n"
      ...
      LCE_BMLA2(v16,  v8, v0, v1, v2, v3) // D1
      LCE_BMLA2(v17,  v8, v4, v5, v6, v7) // D1
      "ld1 {v8.4s}, [%[rhs_ptr]], #16 \n" // Load R3
      LCE_BMLA2(v18,  v9, v0, v1, v2, v3) // D2
      LCE_BMLA2(v19,  v9, v4, v5, v6, v7) // D2
      "ld1 {v9.4s}, [%[rhs_ptr]], #16 \n" // Load R4

      // Accumulation loop over depth
      "cmp w1, w12\n"
      "beq 79f\n"

      "2:\n"

      "ld1 {v10.4s, v11.4s, v12.4s, v13.4s}, [%[lhs_ptr]], #64 \n" // Load next L1

      LCE_BMLA2(v20,  v8, v0, v1, v2, v3) // D3
      LCE_BMLA2(v21,  v8, v4, v5, v6, v7) // D3
      "ld1 {v8.4s}, [%[rhs_ptr]], #16 \n" // Load R5
      LCE_BMLA2(v22,  v9, v0, v1, v2, v3) // D4
      LCE_BMLA2(v23,  v9, v4, v5, v6, v7) // D4
      "ld1 {v9.4s}, [%[rhs_ptr]], #16 \n" // Load R6
      LCE_BMLA2(v24,  v8, v0, v1, v2, v3) // D5
      LCE_BMLA2(v25,  v8, v4, v5, v6, v7) // D5
      "ld1 {v8.4s}, [%[rhs_ptr]], #16 \n" // Load R7
      LCE_BMLA2(v26,  v9, v0, v1, v2, v3) // D6
      LCE_BMLA2(v27,  v9, v4, v5, v6, v7) // D6
      "ld1 {v9.4s}, [%[rhs_ptr]], #16 \n" // Load R8
      LCE_BMLA2(v28,  v8, v0, v1, v2, v3) // D7
      LCE_BMLA2(v29,  v8, v4, v5, v6, v7) // D7
      "ld1 {v8.4s}, [%[rhs_ptr]], #16 \n" // Load R1
      LCE_BMLA2(v30,  v9, v0, v1, v2, v3) // D8
      LCE_BMLA2(v31,  v9, v4, v5, v6, v7) // D8
      "ld1 {v9.4s}, [%[rhs_ptr]], #16 \n" // Load R2

      "ld1 {v4.4s, v5.4s, v6.4s, v7.4s}, [%[lhs_ptr]], #64 \n" // Load next L2

      // L1 was loaded into v10...v13. Move it to v0...v4
      "mov v0.16b, v10.16b \n"
      "mov v1.16b, v11.16b \n"
      "mov v2.16b, v12.16b \n"
      "mov v3.16b, v13.16b \n"
      ...
      "add w1, w1, #4\n" // did another 4 levels of depth
      "cmp w1, w12\n"
      "blt 2b\n"

      "79:\n"

      // Finish up rest of block
      LCE_BMLA2(v20,  v8, v0, v1, v2, v3) // D3
      LCE_BMLA2(v21,  v8, v4, v5, v6, v7) // D3
      "ld1 {v8.4s}, [%[rhs_ptr]], #16 \n" // Load R5
      LCE_BMLA2(v22,  v9, v0, v1, v2, v3) // D4
      ...
      // Not finished last row: then advance to next row.
      // x9 is the LHS stride
      // For 4x4 it is lsl 2: stride * 4 rows
      // For 8x8 it is lsl 3: stride * 8 rows
      ...
      // Not finished last column: then advance to next column.
      // x10 is the RHS stride
      // For 4x4 it is lsl 2: stride * 4 cols
      // For 8x8 it is lsl 3: stride * 8 cols
      ...
      // Compute how much of the 8x8 block of destination values that
      // we have computed, fit in the destination matrix. Typically, all of
      // it fits, but when the destination matrix shape is not a multiple
