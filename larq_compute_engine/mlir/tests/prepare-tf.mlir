...
func @fuse_dilated_bconv(%arg0: tensor<1x128x128x3xf32>) -> tensor<1x128x128x8xf32> {
  ...
  %cst_2 = constant unit
  %0 = "lq.LceBsign"(%arg0) : (tensor<1x128x128x3xf32>) -> tensor<1x128x128x3xf32>
