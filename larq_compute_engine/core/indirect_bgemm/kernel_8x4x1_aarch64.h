...
inline void AccumulationLoop_Depth2OrMore(
  ...
  TBitpacked* a_ptr_3;
  if (IsGrouped) {
    a_ptr_0 = indirection_buffer[0] + input_depth_offset + 1;
    a_ptr_1 = indirection_buffer[1] + input_depth_offset + 1;
    a_ptr_2 = indirection_buffer[2] + input_depth_offset + 1;
    a_ptr_3 = indirection_buffer[3] + input_depth_offset + 1;
  } else {
    a_ptr_0 = indirection_buffer[0] + 1;
    a_ptr_1 = indirection_buffer[1] + 1;
    a_ptr_2 = indirection_buffer[2] + 1;
