...
# Never build against the GPU package
TF_NEED_CUDA=0
...
if [[ $(pip show tensorflow) == *tensorflow* ]] || [[ $(pip show tensorflow-cpu) == *tensorflow* ]] || [[ $(pip show tf-nightly) == *tf-nightly* ]] ; then
  ...
  if [[ "$PIP_MANYLINUX2010" == "0" ]]; then
      ...
      echo 'Installing latest tensorflow......\n'
...
write_to_bazelrc "build:manylinux2010cuda100 --crosstool_top=//ext/toolchains/preconfig/ubuntu16.04/gcc7_manylinux2010-nvcc-cuda10.0:toolchain"
write_to_bazelrc "build:manylinux2010cuda101 --crosstool_top=//ext/toolchains/preconfig/ubuntu16.04/gcc7_manylinux2010-nvcc-cuda10.1:toolchain"
