...
http_archive(
    name = "org_tensorflow",
    sha256 = "30314888b52d535b48952eaefba94d8ec5cafb5befe120c32c47a9dccef149e5",
    strip_prefix = "tensorflow-2.2.0-rc1",
    urls = [
        "https://github.com/tensorflow/tensorflow/archive/v2.2.0-rc1.tar.gz",
    ],
)
