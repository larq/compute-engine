...
http_archive(
    name = "org_tensorflow",
    sha256 = "4fe8b6cc5a863a998e68f38de08348095084bd23bb54276da35ce3fcc7c3ca5a",
    strip_prefix = "tensorflow-2.2.0-rc4",
    urls = [
        "https://github.com/tensorflow/tensorflow/archive/v2.2.0-rc4.tar.gz",
    ],
)
